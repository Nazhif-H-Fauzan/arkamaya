...
<head>
    ...
    <title>Tentang Kami - Nama Perusahaan</title>
    ...
    <style>
        ...
        .text-outline {
            ...
            font-weight: bold;
            color: white;
            -webkit-text-stroke: 2px white; /* Outline teks untuk browser berbasis WebKit */
        }
        ...
        .about-section, .services-section, .case-study-section, .insight-section {
            padding: 60px 0;
        }

        .services-section, .insight-section {
...
<section class="hero-section">
    <div class="container">
        <h1 class="text-outline">Innovate. Grow. Succeed.</h1>
        <p>Kami membantu bisnis berkembang dengan solusi digital yang inovatif dan berkelanjutan.</p>
...
<section class="about-section text-center">
    <div class="container">
        <h2 class="fw-bold text-danger">Tentang Kami</h2>
        <p>Kami adalah tim profesional yang berdedikasi dalam mengembangkan solusi teknologi terbaik untuk bisnis Anda.</p>
        <img src="assets/group-photo.png" alt="Tim Kami" class="img-fluid rounded mt-3">
    </div>
</section>
...
<section class="case-study-section">
    <div class="container text-center">
        <h2 class="fw-bold text-danger">Studi Kasus</h2>
        <p>Kami telah membantu berbagai bisnis dalam mencapai kesuksesan.</p>
        <div class="row mt-4">
            <div class="col-md-6">
                <h4>Proyek E-Commerce</h4>
                <p>Membangun platform e-commerce yang sukses dengan peningkatan penjualan 200%.</p>
            </div>
            <div class="col-md-6">
                <h4>Aplikasi Edukasi</h4>
                <p>Mengembangkan aplikasi edukasi yang telah digunakan oleh lebih dari 50.000 pengguna.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="insight-section">
    <div class="container text-center">
        <h2 class="fw-bold text-danger">Insight & Berita</h2>
        <p>Ikuti berita terbaru dan tren teknologi untuk bisnis Anda.</p>
        <div class="row mt-4">
            <div class="col-md-4">
                <h4>Tren AI 2025</h4>
                <p>Bagaimana AI dapat membantu bisnis berkembang lebih cepat?</p>
            </div>
            <div class="col-md-4">
                <h4>Strategi Pemasaran</h4>
                <p>Mengoptimalkan digital marketing untuk meningkatkan brand awareness.</p>
            </div>
            <div class="col-md-4">
                <h4>Keamanan Data</h4>
                <p>Mengapa keamanan data penting untuk bisnis di era digital?</p>
            </div>
        </div>
    </div>
</section>
